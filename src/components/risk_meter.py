...
class RiskMeter:
    def __init__(self, parent):
        ...
        self.severity = ctk.CTkLabel(
            row, text="NORMAL", font=("Segoe UI", 18, "bold")
        )
        self.severity.pack(side="left")

        self.score = ctk.CTkLabel(
            row, text="0 / 100", font=("Segoe UI", 18, "bold")
        )
    ...
    def update(self, score, severity):
        self.severity.configure(text=f"Exposure: {severity}")
